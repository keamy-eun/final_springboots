...
(
  ...
  COMMUNITY_NAME   VARCHAR(100) NOT NULL COMMENT '게시판이름',
...
(
  ...
  COMMUNITY_CONTENT MEDIUMTEXT   NOT NULL COMMENT '게시글내용',
  COMMUNITY_TITLE   VARCHAR(100) NOT NULL COMMENT '게시글제목',
  FILE_ATTACHIMENT  VARCHAR(100) NULL     COMMENT '첨부파일',
  COMMUNITY_DATE    VARCHAR(100) NOT NULL COMMENT '작성일',
...
(
  ...
  POSITION     VARCHAR(100) NOT NULL COMMENT '권한',
...
(
  ...
  POST_DATE       VARCHAR(100) NOT NULL COMMENT '작성일',
  POST_NUMBER     VARCHAR(100) NOT NULL COMMENT '게시글번호',
