...
(
  POST_NUMBER      VARCHAR(100) NULL     COMMENT '게번호',
...
(
  ...
  VIEW_COUNT        VARCHAR(100) NULL     COMMENT '조회수',
  MEMBER_ID         VARCHAR(100) NOT NULL COMMENT '아이디',
  COMMUNITY_NUMBER  VARCHAR(100) NOT NULL COMMENT '게시판번호',
  PRIMARY KEY (POST_NUMBER)
) COMMENT '게시글';

CREATE TABLE COMMUNITY_POST_CONNECTION
(
  COMMUNITY_NUMBER VARCHAR(100) NOT NULL COMMENT '게시판번호',
...
(
  ...
  STUDENT_COUNT   VARCHAR(100) NULL     COMMENT '수강생수',
...
(
  ...
  POST_NUMBER       VARCHAR(100) NULL     COMMENT '글번호',
  POST_TITLE        VARCHAR(100) NULL     COMMENT '제목',
  POST_REVIEW_COUNT INTEGER      NULL     COMMENT '게시글리뷰수',
  MEMBER_ID         VARCHAR(100) NULL     COMMENT '작성자아이디',
  POSTING_DATE      VARCHAR(100) NULL     COMMENT '작성일',
  VIEW_COUNT        INTEGER      NULL     COMMENT '조회수',
  PAGE_NUMBER       INTEGER      NULL     COMMENT '페이지번호',
...
(
  인증키          VARCHAR(100) NOT NULL COMMENT '인증키',
  MEMBER_ID    VARCHAR(100) NOT NULL COMMENT '아이디',
...
ALTER TABLE COMMUNITY_LECTURER
  ADD CONSTRAINT FK_COMMUNITY_POST_CONNECTION_TO_COMMUNITY_LECTURER
    FOREIGN KEY (COMMUNITY_NUMBER)
    REFERENCES COMMUNITY_POST_CONNECTION (COMMUNITY_NUMBER);

ALTER TABLE COMMUNITY_STUDENT
  ADD CONSTRAINT FK_COMMUNITY_POST_CONNECTION_TO_COMMUNITY_STUDENT
    FOREIGN KEY (COMMUNITY_NUMBER)
    REFERENCES COMMUNITY_POST_CONNECTION (COMMUNITY_NUMBER);

ALTER TABLE COMMUNITY_NOTICE
  ADD CONSTRAINT FK_COMMUNITY_POST_CONNECTION_TO_COMMUNITY_NOTICE
    FOREIGN KEY (COMMUNITY_NUMBER)
    REFERENCES COMMUNITY_POST_CONNECTION (COMMUNITY_NUMBER);

ALTER TABLE COMMUNITY_LECTURE
  ADD CONSTRAINT FK_COMMUNITY_POST_CONNECTION_TO_COMMUNITY_LECTURE
    FOREIGN KEY (COMMUNITY_NUMBER)
    REFERENCES COMMUNITY_POST_CONNECTION (COMMUNITY_NUMBER);

ALTER TABLE LECTURE_REVIEW
  ADD CONSTRAINT FK_COMMUNITY_POST_CONNECTION_TO_LECTURE_REVIEW
    FOREIGN KEY (COMMUNITY_NUMBER)
    REFERENCES COMMUNITY_POST_CONNECTION (COMMUNITY_NUMBER);

ALTER TABLE COMMUNITY_POST
  ADD CONSTRAINT FK_COMMUNITY_POST_CONNECTION_TO_COMMUNITY_POST
    FOREIGN KEY (COMMUNITY_NUMBER)
    REFERENCES COMMUNITY_POST_CONNECTION (COMMUNITY_NUMBER);
