...
(
  LECTURER_NUMBER VARCHAR(100) NOT NULL COMMENT '강사번호',
  LECTURER_NAME   VARCHAR(100) NULL     COMMENT '강사명',
...
ALTER TABLE COMMUNITY_POST
  ADD CONSTRAINT FK_COMMUNITY_POST_TO_COMMUNITY_POST
    FOREIGN KEY (COMMUNITY_NUMBER)
    REFERENCES COMMUNITY_POST (COMMUNITY_NUMBER);
...
ALTER TABLE COMMUNITY_NOTICE
  ADD CONSTRAINT FK_COMMUNITY_POST_TO_COMMUNITY_NOTICE
    FOREIGN KEY (COMMUNITY_NUMBER)
    REFERENCES COMMUNITY_POST (COMMUNITY_NUMBER);

ALTER TABLE COMMUNITY_STUDENT
  ADD CONSTRAINT FK_COMMUNITY_POST_TO_COMMUNITY_STUDENT
    FOREIGN KEY (COMMUNITY_NUMBER)
    REFERENCES COMMUNITY_POST (COMMUNITY_NUMBER);

ALTER TABLE COMMUNITY_LECTURE
  ADD CONSTRAINT FK_COMMUNITY_POST_TO_COMMUNITY_LECTURE
    FOREIGN KEY (COMMUNITY_NUMBER)
    REFERENCES COMMUNITY_POST (COMMUNITY_NUMBER);

ALTER TABLE LECTURE_REVIEW
  ADD CONSTRAINT FK_COMMUNITY_POST_TO_LECTURE_REVIEW
    FOREIGN KEY (COMMUNITY_NUMBER)
    REFERENCES COMMUNITY_POST (COMMUNITY_NUMBER);

ALTER TABLE COMMUNITY_LECTURER
  ADD CONSTRAINT FK_COMMUNITY_POST_TO_COMMUNITY_LECTURER
    FOREIGN KEY (COMMUNITY_NUMBER)
    REFERENCES COMMUNITY_POST (COMMUNITY_NUMBER);
