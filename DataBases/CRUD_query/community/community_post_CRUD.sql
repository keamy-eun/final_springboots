...
-- 게시판과 유저
SELECT POST_NUMBER,COMMUNITY_CONTENT,COMMUNITY_TITLE,FILE_ATTACHIMENT,COMMUNITY_DATE,VIEW_COUNT,community_post.MEMBER_ID,COMMUNITY_NUMBER,PW,MEMBER_NAME,POSITION,BIRTH,EMAIL,SMS_AD,EMAIL_AD,PRIVACY_INFO
FROM community_post
inner join member where community_post.MEMBER_ID = member.MEMBER_ID
;
-- 게시판 종류와 게시판내용
SELECT POST_NUMBER,COMMUNITY_CONTENT,COMMUNITY_TITLE,FILE_ATTACHIMENT,COMMUNITY_DATE,VIEW_COUNT,MEMBER_ID,community.COMMUNITY_NUMBER,COMMUNITY_NAME
FROM community_post
inner join community where community_post.COMMUNITY_NUMBER = community.COMMUNITY_NUMBER
;
-- 댓글과 게시판 내용
SELECT community_post.POST_NUMBER,COMMUNITY_CONTENT,COMMUNITY_TITLE,FILE_ATTACHIMENT,COMMUNITY_DATE,VIEW_COUNT,COMMUNITY_NUMBER,COMMENT_NUMBER,COMMENT_CONTENT,POST_DATE,post_comment.MEMBER_ID
FROM community_post
