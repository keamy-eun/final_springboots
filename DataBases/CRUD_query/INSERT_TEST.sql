...
--   0308 추가 INSERT [강좌게시판 에러사항 개선 내용]
('POST10', '학생게시판이에요 반가워요', '학생게시판이다', null, now(), '0', 'circle01', 'C03'),
('POST11', '겨울에 추운데 무슨 특강이에요', '[은정이아카데미] 겨울방학 특강 안내[124]', null, now(), '0', 'admin', 'C04'),
('POST12', '학사 일정 안내해드릴까요? 좋지요', '[은정이아카데미] 학사일정 안내[5]', null, now(), '0', 'admin', 'C04'),
('POST13', '할인혜택은 사실 거짓말이에요', '[은정이아카데미] 이달의 이벤트와 할인 혜택[1120]', null, now(), '0', 'admin', 'C04'),
('POST14', '강의시간도 모르고 수업듣는 사람은 없겠죠?', '[은정이아카데미] 강의 시간표 [101]', null, now(), '0', 'admin', 'C04'),
('POST15', '사실 아무 계획도 없어요', '2023 프로그램 연간계획서', null, now(), '0', 'ceromi123', 'C02'),
('POST16', '성범죄는 아주 못된 짓이에요 하지 않도록 해요', '성범죄 조회 동의서(양식)', null, now(), '0', 'ceromi123', 'C02'),
('POST17', '겨울방학에는 강사도 쉬고싶지만 돈벌기위해 어쩔수없어요', '겨울방학 특강 운영 및 안전관리 연수자료', null, now(), '0', 'ceromi123', 'C02'),
('POST18', '필수연수수수수', '특강 강사 필수 연수 목록', null, now(), '0', 'ceromi123', 'C02')
;
