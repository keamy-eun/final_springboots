...
values ('LECTURE_24', '영어회화초급01','2022-09-10',580,'LECTURER_06','ceromi123','영어 단어를 외웠는데도 회화에 적용이 안 되나요? 영어로 계속해서 대화를 이끌어나가는 게 어려운가요?회화에 자주 쓰이는 단어만 골라서 외우고 싶으신가요? 영어 단어를 주제별로 공부하고 싶으신분. 영어회화초급반이 딱입니다!'),
('LECTURE_12', '영어문법중급A','2023-01-11',410,'LECTURER_06','ceromi123','문법을 배우기엔 지겹고,회화를 배우려니 자신이 없으신 분들! 최소한의 문법으로 최대한의 회화 실력을 이끌어 드립니다. 문법에 재미를 느낄 수 있는 문법 중급 강좌'),
('LECTURE_13', '850점 토익챌린지','2023-02-11',14510,'LECTURER_06','ceromi123','650~750 사이 토익공부에 어려움을 느끼시는 분들! 주저말고 신청하세요 토익 만점자 도우너 선생님의 수업과 함께 단기간 점수상승의 기회! 학습한 영어 단어를 활용한 다양한 예문 소개'),
('LECTURE_14', '누구나 할수있는 8주 영어문법 마스터','2022-08-11',41880,'LECTURER_06','ceromi123','홍길동 선생님의 이해가 쏙쏙되는 강의를 들어보세요 수강생들 모두가 만족하는 강의로써 2달간 영어 문법을 듣고 기초적인 문법을 다져보세요 홍길동 선생님의 이해가 쏙쏙되는 강의를 들어보세요 아주 만족하실거에요~'),
('LECTURE_15', '평범한 직장인의 비즈니스 일상회화','2023-01-19',1810,'LECTURER_06','ceromi123','- 획일화된 비즈니스 상황에 집중된 강의에서 벗어나, 평범한 직장인이 맞닥뜨릴 수 있는 회사 관련 일상 회화를 배워 보는 강의 / 어렵고 적용하기 힘든 비즈니스 용어가 아닌 동료와의 관계, 회사 생활, 일상적인 업무에 관한 비즈니스 회화 강의'),
('LECTURE_16', '시추에이션 영작문','2022-07-25',41630,'LECTURER_06','ceromi123','★ 상황으로 쉽고 재밌게 배우는 영작문 강의! 직장, 여행, 일상회화, 인터뷰 상황에서 쓸 수 있는 다양한 문장을 영작해볼 수 있고 상황 별로 자주 사용하는 표현, 패턴을 기반으로 쉽고 효과적으로 문장을 영작할 수 있게됩니다. 영작 뿐 아니라 회화에도 활용할 수 있는 강의'),
('LECTURE_17', '나의 행동을 표현하는 모든 영어 1','2022-11-27',14610,'LECTURER_06','ceromi123','결재 서류를 올리다? QR코드를 찍다? 일상생활에서의 나의 행동을 사소하지만 영어로 어떻게 표현하는지 미처 알지 못했던 단어와 표현이 있으셨죠? 친구나 동료와 나의 평범한 일상을 영어로 이야기 할 수 있도록, 어휘력 업그레이드가 필요합니다.');
