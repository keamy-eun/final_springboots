          ...
          <div class="row">
            ...
            <div class="container col-7 mt-5">
              ...
              <table class="table text-start">
                ...
                <div class="col-3 h4"><a href="#" style="text-decoration: none;" class="text-black">학생게시판</a> </div>
                <div class="col-3 h4"><a href="#" style="text-decoration: none;" class="text-black">강좌게시판</a> </div>
                <div class="col-3 h4"><a href="#" style="text-decoration: none;" class="text-black">공지사항</a></div>
              </div>
              <!-- 글쓰기 -->
              <div class="mb-3 text-end">
                <button class="border btn">
                  <a
                    href="./community_posting.html"
                    class="text-black"
                ...
                <tbody>
                  ...
                  <tr>
                    <td>2</td>
                    <td>[회화 입문] 회화, 영어로 말해봐!! 30일의 기적</td>
                    <td>Bob Doe</td>
                    <td>2023-01-03</td>
